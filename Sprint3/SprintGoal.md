...
## Ciljevi sprinta
Cilj ovog sprinta je definisanje arhitekture i domenskog modela, uz planiranje načina testiranja i prepoznavanje rizika koji bi mogli usporiti tim. Isplaniranim modelima i strategijama želimo osigurati da razvoj krene na jasnim temeljima, a ne na nasumičnim odlukama.
...
### Rizici
* Rizik da domenski model ne podržava sve scenarije definisane u User Stories.
* Rizik da odabrana arhitektura bude previše kompleksna za MVP fazu projekta.
* Rizik od tehničkih kvarova (hardver, internet) koji mogu usporiti izradu artefakata.
* Neusklađenost članova tima oko ključnih tehničkih odluka ili raspodjele obaveza.

### Zavisnosti
* Arhitektura i domenski model zavise od jasnoće korisničkih priča na kojima se temelje
* Strategija testiranja i Use Case modeli direktno zavise od preciznosti AC-ova iz prošlog sprinta